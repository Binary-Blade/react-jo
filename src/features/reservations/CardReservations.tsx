  ...
  return (
    <>
      <Card
        ...
        duration-300 hover:-translate-y-1 hover:shadow-lg dark:border-gray-800 dark:bg-gray-950"
      >
        <CardHeader>
          <div className="flex items-center justify-between gap-10">
            <CardTitle className="text-xl">{reservation.reservationDetails?.title}</CardTitle>
            <div
              className={`px-2 py-1 rounded-md border text-sm font-medium ${STATUSCOLOR[reservation.transaction.statusPayment]}`}
            >
