        ...
        {transactions.length > 0 ? (
          transactions.map(transaction => (
            <div key={transaction.transactionId} className="mb-6">
              ...
              <Collapsible>
                <CollapsibleTrigger className="font-semibold text-xl flex items-center text-rose-600 gap-1 transition-transform duration-300 ease-in-out [&[data-state=open]>svg]:rotate-90">
                  Voir vos Billets
