            ...
            <section className="py-20 bg-white dark:bg-gray-800">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="text-center">
                        <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white sm:text-4xl">Latest News</h2>
                                ...
                                <div className="flex-1">
                                    ...
                                    <Link className="block mt-2" href="#">
                                        ...
                                        <p className="mt-3 text-base text-gray-500">
                                            The International Olympic Committee has announced the addition of several new sports to the
